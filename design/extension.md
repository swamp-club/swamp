...
### extension push \<manifest-path\>

Packages and pushes an extension to the registry.

Options:

- `--repo-dir <dir>` — Repository directory (default: `.`)
- `-y, --yes` — Skip confirmation prompts
- `--dry-run` — Build archive locally without pushing to the registry

### extension pull \<extension\>

Pulls an extension from the registry into the local repository. The extension
argument can include an optional version: `@ns/name` (latest) or
`@ns/name@2026.02.26.1` (specific version).
...
Removes a pulled extension and its files from the local repository.
