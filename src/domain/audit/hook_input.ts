...
/**
 * Pi: tool_call / tool_result extension events.
 * Payload shape matches OpenCode: tool_name, tool_input.command, cwd,
 * session_id. Generated by .pi/extensions/swamp-audit.ts.
 */
function normalizePi(
  raw: Record<string, unknown>,
): NormalizedHookInput | null {
  if (raw.tool_name !== "bash") return null;
