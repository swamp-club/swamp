...
If models already exist, start by reading \`${skillsDir}/swamp/SKILL.md\`
...
${
      skillListEntry(
        "swamp",
        "Swamp CLI — models, workflows, data, vaults, extensions, publishing, repos, reports, issues, and troubleshooting",
      )
    }
${
      skillListEntry(
