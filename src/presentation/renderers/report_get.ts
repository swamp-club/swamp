...
/** Standalone render function for use by the search command's detail view. */
export function renderReportGet(
  data: StoredReportDetail,
  mode: OutputMode,
): void {
  const renderer = createReportGetRenderer(mode);
