...
import { createLibSwampContext, result } from "../../libswamp/mod.ts";
import { reportSearch } from "../../libswamp/reports/search.ts";
import type { ReportSearchDeps } from "../../libswamp/reports/search.ts";
import { reportGet } from "../../libswamp/reports/get.ts";
import type { ReportGetDeps } from "../../libswamp/reports/get.ts";
import type { StoredReportSummary } from "../../libswamp/reports/report_views.ts";
...
import { renderReportGet } from "../../presentation/renderers/report_get.ts";
...
async function displayReportDetail(
  ...
  renderReportGet(getResult.data, outputMode);
}
