...
minute there. A CLI run that loses its session this way stops and prints the
reason rather than reconnecting. The socket closes with code `4003` and a reason
